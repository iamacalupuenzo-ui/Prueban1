...
@Component({
  ...
  template: `
    @if (rendered()) {
      <div
        class="side-drawer__mask"
        [class.side-drawer__mask--visible]="visible()"
        (mousedown)="onOverlayMouseDown($event)"
      >
        <aside
          #panel
          class="side-drawer"
          [class.side-drawer--visible]="visible()"
          [class.side-drawer--canvas]="surface === 'canvas'"
          role="dialog"
          aria-modal="true"
  ...
  styles: [
    `
      ...
      .side-drawer {
        ...
        width: min(560px, calc(100vw - var(--layout-padding-4xl)));
      ...
      .side-drawer__header {
        ...
        padding: 0 var(--layout-padding-2xl);
        border-bottom: var(--layout-border-thin) solid #e4dac9;
      }
      ...
      .side-drawer__close {
        ...
        cursor: pointer;
        transition: opacity var(--motion-duration-leaving) var(--motion-easing-default);
      }
      ...
      .side-drawer__footer {
        ...
        border-top: var(--layout-border-thin) solid #e4dac9;
      }
...
export class SideDrawerComponent implements OnChanges, OnDestroy {
  ...
  @Input() surface: 'default' | 'canvas' = 'default';
