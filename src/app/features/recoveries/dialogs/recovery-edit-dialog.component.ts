        ...
        <form class="recovery-form" (submit)="onSubmit($event)" novalidate>
          <div class="field-grid">
            ...
            <div class="two-col-grid">
              <div class="form-field">
                <label for="recovery-edit-source-name">Nombre de la fuente <span class="required-marker" aria-hidden="true">*</span></label>
                <cs-input
                  id="recovery-edit-source-name"
                  name="recovery-edit-source-name"
                  fieldSize="md"
                  autocomplete="off"
            ...
            <div class="two-col-grid">
              <div class="form-field">
                <label for="recovery-edit-contact-name">Nombre de contacto <span class="required-marker" aria-hidden="true">*</span></label>
                <cs-input
              ...
              <div class="form-field">
                <label for="recovery-edit-contact-phone">Teléfono de contacto <span class="required-marker" aria-hidden="true">*</span></label>
                <cs-input
